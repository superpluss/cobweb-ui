	...
	<div>
		...
		>
			...
			<a-layout>
				...
				<a-button class="fab" shape="circle" @click="toggleSettingsDrawer(true)">
					<svg
						width="20"
						height="20"
						viewBox="0 0 20 20"
...
const toggleSettingsDrawer = (value: boolean) => {
	console.log("parent emit:toggleSettingsDrawer",value)
	showSettingsDrawer = value;
}
const toggleNavbarPosition = (value: boolean) => {
	console.log("parent emit:toggleNavbarPosition",value)
	navbarFixed = value;
}
const updateSidebarTheme = (value: string) => {
	console.log("parent emit:updateSidebarTheme",value)
	sidebarTheme = value;
}
const updateSidebarColor = (value: string) => {
	console.log("parent emit:updateSidebarColor",value)
	sidebarColor = value;
}
