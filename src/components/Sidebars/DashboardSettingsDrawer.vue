...
const emit = defineEmits(['toggleSettingsDrawer', 'updateSidebarColor', 'updateSidebarTheme', 'toggleNavbarPosition'])
...
let wrapper: HTMLElement | null = document.body;

// Main sidebar color.
const sidebarColorModel = props.sidebarColor;

// Main sidebar theme : light, white, dark.
const sidebarThemeModel = props.sidebarTheme;

// Header fixed status.
const navbarFixedModel = props.navbarFixed;
...
const fnToggleSettingsDrawer = () => {
  console.log("child emit:toggleSettingsDrawer")
  emit('toggleSettingsDrawer', false)
}
</script>
