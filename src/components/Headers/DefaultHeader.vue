	...
	<a-layout-header>
		...
		<div class="header-col header-nav">
			...
			<a-menu mode="horizontal" class="menu-large">
				<a-menu-item>
					<router-link to="/dashboard" class="nav-link" @click.prevent>
				...
				<a-menu-item>
					<router-link to="/profile" class="nav-link" @click.prevent>
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<a-menu-item>
					<router-link to="/sign-in" class="nav-link" @click.prevent>
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<a-menu-item>
					<router-link to="/sign-up" class="nav-link" @click.prevent>
